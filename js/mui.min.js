...
function wxLogin(goto){
	plus.oauth.getServices(function(services){
		...
		mui.post('http://hoa.hcoder.net/index.php?c=members&m=addByWx ',{
			...
			mui.toast('获取微信登陆认证失败'+'--'+e.message+'--'+e.code);
		})
	},function(e){
		mui.toast('获取微信登陆认证列表失败'+'--'+e.message+'--'+e.code);
	})
}
//退出登录
function logout(){
	plus.oauth.getServices(function(services){
		...
		index.evalJS('changeSub(0);h("#navfooter").find("a").removeClass("mui-active");h("#sub1").addClass("mui-active")');
